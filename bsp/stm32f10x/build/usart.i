...
#line 18 "drivers\\usart.c"
#line 1 "drivers\\usart.h"
...
#line 15 "drivers\\usart.h"
#line 16 "drivers\\usart.h"
...
static rt_err_t stm32_configure(struct rt_serial_device *serial, struct serial_configure *cfg)
{
    ...
    if (!(serial != (0))) { rt_assert_handler("serial != RT_NULL", __FUNCTION__, 74); };
    if (!(cfg != (0))) { rt_assert_handler("cfg != RT_NULL", __FUNCTION__, 75); };
...
static rt_err_t stm32_control(struct rt_serial_device *serial, int cmd, void *arg)
{
    ...
    if (!(serial != (0))) { rt_assert_handler("serial != RT_NULL", __FUNCTION__, 115); };
    uart = (struct stm32_uart *)serial->parent.user_data;
...
static int stm32_putc(struct rt_serial_device *serial, char c)
{
    ...
    if (!(serial != (0))) { rt_assert_handler("serial != RT_NULL", __FUNCTION__, 150); };
    uart = (struct stm32_uart *)serial->parent.user_data;

    if (serial->parent.open_flag & 0x400)
    {
        if (!(uart->uart_device->SR & ((uint16_t)0x0080)))
        {
            USART_ITConfig(uart->uart_device, ((uint16_t)0x0626), ENABLE);
            return -1;
        }
    ...
    {
        USART_ClearFlag(uart->uart_device,((uint16_t)0x0040));
        uart->uart_device->DR = c;
...
static int stm32_getc(struct rt_serial_device *serial)
{
    ...
    if (!(serial != (0))) { rt_assert_handler("serial != RT_NULL", __FUNCTION__, 178); };
    uart = (struct stm32_uart *)serial->parent.user_data;
...
static void dma_uart_rx_idle_isr(struct rt_serial_device *serial) {
    ...
    if (recv_len) rt_hw_serial_isr(serial, 0x03 | (recv_len << 8));
...
static void uart_isr(struct rt_serial_device *serial) {
    ...
    if (!(uart != (0))) { rt_assert_handler("uart != RT_NULL", __FUNCTION__, 250); };

    if(USART_GetITStatus(uart->uart_device, ((uint16_t)0x0525)) != RESET)
    {
        if(USART_GetFlagStatus(uart->uart_device, ((uint16_t)0x0001)) == RESET)
        {
    ...
    if (USART_GetITStatus(uart->uart_device, ((uint16_t)0x0626)) != RESET)
    {
        ...
        if(serial->parent.open_flag & 0x400)
        {
            rt_hw_serial_isr(serial, 0x02);
        }
        USART_ITConfig(uart->uart_device, ((uint16_t)0x0626), DISABLE);
...
struct stm32_uart uart2 =
{
    ...
    USART2_IRQn,
    {
        ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x006C)),
        ((uint32_t)0x00100000),
        DMA1_Channel6_IRQn,
        0,
    },
...
struct stm32_uart uart3 =
{
    ...
    USART3_IRQn,
    {
        ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0030)),
        ((uint32_t)0x00000100),
        DMA1_Channel3_IRQn,
        0,
    },
...
static void RCC_Configuration(void)
{
    ...
    RCC_APB2PeriphClockCmd(((uint32_t)0x00000008) | ((uint32_t)0x00000001), ENABLE);
     
    RCC_APB1PeriphClockCmd(((uint32_t)0x00040000), ENABLE);


#line 488 "drivers\\usart.c"
}
