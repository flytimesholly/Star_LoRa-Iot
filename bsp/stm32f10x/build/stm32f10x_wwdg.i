...
void WWDG_SetPrescaler(uint32_t WWDG_Prescaler)
{
  ...
  (((((WWDG_Prescaler) == ((uint32_t)0x00000000)) || ((WWDG_Prescaler) == ((uint32_t)0x00000080)) || ((WWDG_Prescaler) == ((uint32_t)0x00000100)) || ((WWDG_Prescaler) == ((uint32_t)0x00000180)))) ? (void)0 : assert_failed((uint8_t *)"Libraries\\STM32F10x_StdPeriph_Driver\\src\\stm32f10x_wwdg.c", 122));
...
void WWDG_SetWindowValue(uint8_t WindowValue)
{
  ...
  ((((WindowValue) <= 0x7F)) ? (void)0 : assert_failed((uint8_t *)"Libraries\\STM32F10x_StdPeriph_Driver\\src\\stm32f10x_wwdg.c", 142));
...
void WWDG_SetCounter(uint8_t Counter)
{
  ...
  (((((Counter) >= 0x40) && ((Counter) <= 0x7F))) ? (void)0 : assert_failed((uint8_t *)"Libraries\\STM32F10x_StdPeriph_Driver\\src\\stm32f10x_wwdg.c", 173));
...
void WWDG_Enable(uint8_t Counter)
{
  ...
  (((((Counter) >= 0x40) && ((Counter) <= 0x7F))) ? (void)0 : assert_failed((uint8_t *)"Libraries\\STM32F10x_StdPeriph_Driver\\src\\stm32f10x_wwdg.c", 188));
